// Package asnlookup provides a Go client for the ASN Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/asnlookup?utm_source=go&utm_medium=readme
package asnlookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/asnlookup"
	defaultTimeout = 30 * time.Second
)

// Client is the ASN Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new ASN Lookup API client.
...
// Execute makes a request to the ASN Lookup API with typed parameters.
//
...
//   - asn (required): string - The ASN you want to get information about
