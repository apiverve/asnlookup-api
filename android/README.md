...
```gradle
dependencies {
    implementation 'com.github.apiverve:asnlookup-api:1.1.14'
}
```
...
```java
import com.apiverve.asnlookup.ASNLookupAPIClient;
import com.apiverve.asnlookup.APIResponse;
import com.apiverve.asnlookup.APIException;

// Initialize the client
ASNLookupAPIClient client = new ASNLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("asn", "AS15169");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/asnlookup](https://docs.apiverve.com/ref/asnlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/asnlookup](https://docs.apiverve.com/ref/asnlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/asnlookup-api/issues)
