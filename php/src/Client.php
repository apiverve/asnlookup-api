 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/asnlookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/asnlookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AsnlookupClient] {$message}\n";
        }
    }
}
