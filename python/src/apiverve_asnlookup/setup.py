...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/asnlookup',
        'Source': 'https://github.com/apiverve/asnlookup-api',
        'Bug Tracker': 'https://github.com/apiverve/asnlookup-api/issues'
    },
    classifiers=[
